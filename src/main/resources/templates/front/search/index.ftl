...
<div id="qing-notice-cnt">
	<div class="qing-notice">
		<i class="am-icon-search"></i><span id="qing-notice-text">搜索【${keyWord!}】相关内容如下</span>
	</div>
</div>
<div id="blog-list">
...
<!-- 分页 -->
<@paginate currentPage=page.number + 1  totalPage=page.totalPages link="/s?keyword=" + keyWord + "&p=" />
</@html>
